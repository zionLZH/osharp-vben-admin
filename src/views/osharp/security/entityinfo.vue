<template>
  <div>
    ...
    <EntityinfoDtl v-if="dtlPayload" :payload="dtlPayload" @close="onDtlModalClosed" />
  </div>
</template>
<script lang="ts" setup>
  import { ref } from 'vue'
  import { BasicTable, TableAction, useTable } from '../../../components/Table'
  import { Read } from '../../../api/osharp/Entityinfo'
  import { makeOSharpPage } from '../../../utils/osharp'
  import { Colums, FormConfig, ActionConfig, getFilterItems } from './data/entityinfo'
  import { OSharpPageOption } from '../../../utils/osharp/types/page'
  import EntityinfoDtl from './modal/entityinfoDtl.vue'
